...
from .views import ShowListView, ShowDetailView, ShowCreateCommentView, EpisodeDetailView
...
urlpatterns = [
    ...
    path('<slug:slug>/comment/', ShowCreateCommentView.as_view(), name='create_comment'),
